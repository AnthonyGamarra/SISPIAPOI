...
import { SelectorGestionComponent } from '../../components/main-components/selector-gestion/selector-gestion.component';
import { FormulacionGestionTablaComponent } from '../../components/main-components/formulacion-gestion-tabla/formulacion-gestion-tabla.component';
import { Formulation } from '../../models/logic/formulation.model';

@Component({
  selector: 'app-formulacion-gestion',
  standalone: true,
  imports: [
    CommonModule,
    FooterComponent,
    MenubarComponent,
    SelectorGestionComponent,
    FormulacionGestionTablaComponent,
  ],
  templateUrl: './formulacion-gestion.component.html',
  styleUrl: './formulacion-gestion.component.scss',
})
export class FormulacionGestionComponent {
  // We still keep ViewChild, but its direct manipulation will be minimized
  @ViewChild(FormulacionGestionTablaComponent) formulacionTablaComponent!: FormulacionGestionTablaComponent;
