...
@Component({
  selector: 'app-adm-maestros-od-modulo',
  imports: [],
  templateUrl: './adm-maestros-od-modulo.component.html',
  styleUrl: './adm-maestros-od-modulo.component.scss'
})
export class AdmMaestrosODModuloComponent {
  constructor(private router: Router) {}
  @Output() clicked = new EventEmitter<void>();

  onClick() {
  this.router.navigate(['/gestion/adm-maestro-gestion-od']).then(success => {
    if (success) {
